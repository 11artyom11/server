...
/**
 * @brief Construct a new Basic Connection Handler:: Basic Connection Handler object
 * 
 */
 ...
 */
bool BasicConnectionHandler::setup_socket(int __domain, 
                                            int __type, 
                                                int __protocol)
{
 ...
 */
bool BasicConnectionHandler::setup_server_addr (int __family,
                                                    std::string __host,
                                                        uint32_t __port)
{
    Debug().info("Called BasicConnectionHandler::setup_server_addr(...) function");
 ...
 * @return false 
 */
bool BasicConnectionHandler::set_server_addr (struct sockaddr_in* new_serv_addr)
{
