...
int ClientModel::send_join_to_room_request(const std::string& master_token, const std::string& room_id)
{
    // auto utoken = get_comm_unit()->get_io_model()->get_handler()->get_client_prototype_ptr_c()->unique_token;
